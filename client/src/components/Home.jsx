            ...
            <div className="page-top">
                    ...
                    <header class="masthead bg-primary text-white text-center">
                        <div class="container d-flex align-items-center flex-column">
                            ...
                            {/* <!-- Masthead Heading--> */}
                            <h1 class="masthead-heading text-uppercase mb-0">Madlibs</h1>
                            {/* <!-- Icon Divider--> */}
                            ...
                            {/* <!-- Masthead Subheading--> */}
                            <p class="masthead-subheading font-weight-light mb-0">The world's greatest word game</p>
                        </div>
                    </header>
                    {/* <!-- Portfolio Section--> */}
                    <section class="page-section portfolio" id="portfolio">
                        <div class="container">
                            ...
                            <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Pick your adventure</h2>
                            {/* <!-- Icon Divider--> */}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4 mb-5">
                                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal1">
                                        ...
                                        <Link class="portfolio-item-caption-content text-center text-white" to="/camp">Letters from camp</Link>
